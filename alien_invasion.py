...
class AlienInvasion:
    ...
    def __init__(self):
        """Initialising the game and resources"""
        pygame.init()
    ...
    def _check_events(self):
        # Watch for keyboard and mouse prompts
    ...
    def _update_bullets(self):
        """Updates bullets and gets rid of old ones"""
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            #Decrement ships hit and update scoreboard
    ...
    def _update_aliens(self):
        """Check if the fleet is at the edge and then update position of 
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                #treat this as it the ship is hit
                _ship_hit()
                break
